...
from .scan import build_frequency_axis, build_z_axis, predicted_center_hz
...
def _configure_outputs(
    ...
    demod.configure_oscillator(
        ...
        OscillatorConfig(
            ...
            frequency=params.zero_bias_center_frequency_hz,
        ),
    )
    ...
    print(
        f"Mx Z 标定工作点已配置，温度 {actual_temperature:.2f} °C，"
