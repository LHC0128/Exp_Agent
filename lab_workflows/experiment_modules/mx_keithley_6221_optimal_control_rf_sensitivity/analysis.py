"""Mx Keithley 6221 最优控制 RF 灵敏度离线分析。"""
...
def _analyze_residual_control_phase_scan(
    ...
    result = {
        ...
        "keithley_calibration": config.get("keithley_calibration", {}),
...
def analyze(run_dir: Path) -> dict[str, Any]:
    ...
    result = analyze_rf_sensitivity(
        run_dir,
        params_type=MxKeithley6221OptimalControlRFParams,
    )
    result.update(
        {
            "experiment_id": "mx-keithley-6221-optimal-control-rf-sensitivity",
...
def main() -> int:
    ...
    print(f"Mx Keithley 6221 最优控制 RF 灵敏度分析完成: {result['run_dir']}")
